...
Русскоязычный агрегатор новостей на стыке frontend и AI на Cloudflare Workers. Раз в час он получает Google News RSS и дополнительные ленты, отбирает материалы, которые касаются обеих тем сразу, переводит новые через OpenRouter, сохраняет их в D1, публикует на сайте и в Telegram.
...
- `languages.supported` — языки сайта (сейчас только русский); `languages.source` — язык источника, копируется без LLM и на сайте не показывается;
